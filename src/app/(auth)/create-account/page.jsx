...
const Register = () => {
  ...
  const createNewAccount = async (event) => {
    ...
    if (!securityTest(name) || !securityTest(email) || !securityTest(pass)) {
      alert("Invalid format name/email/password!");
      return;
    }
      ...
      <div className="min-h-screen flex justify-center items-center bg-white">
        <div className="card max-w-sm shadow-2xl bg-white p-2">
          <form className="card-body" onSubmit={createNewAccount}>
            <h2 className="mb-2 text-xl font-sans text-start text-clearGreen">
              Create Account
            </h2>
