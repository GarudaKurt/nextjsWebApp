...
const CardLabel = ({image, name, title, descriptions}) => {
    return(
        ...
        <button className="bg-transparent hover:bg-green-500 text-clearGreen font-semibold hover:text-white mb-2 py-2 px-4 border border-green-500 hover:border-transparent rounded">
            Add Cart
        </button>
      </div>
    )
